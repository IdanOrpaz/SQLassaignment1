...
class Volunteer {
    public:
        ...
        // methods we created 
        void setCompletedOrderIdToNoOrder();
        virtual int type() const = 0; //  1 = collector | 2 = limited collector | 3 = driver  | 4 = limited driver
        bool getIsDeleted();
        void Delete();
...
class CollectorVolunteer: public Volunteer {
    ...
    public:
        ...
        // methods we created 
         ...
         int type() const override; //  1 = collctor | 2 = limited collector | 3 = driver  | 4 = limited driver
...
class LimitedCollectorVolunteer: public CollectorVolunteer {
    ...
    public:
        ...
        // methods we created 
         ...
         int type() const override; //  1 = collector | 2 = limited collector | 3 = driver  | 4 = limited driver
